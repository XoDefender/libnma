                                  ...
                                  gboolean ask_mode)
{
	...
	if (setting && password_flags_name)
	{
		...
		if (with_not_required && secret_flags == NM_SETTING_SECRET_FLAG_NONE 
			&& (!strcmp(password_flags_name, "ca-cert-password") || !strcmp(password_flags_name, "client-cert-password")))
		{
